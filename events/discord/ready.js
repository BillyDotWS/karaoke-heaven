		...
		if(announcetime <= 900) {
			...
			if(eventinfo[0].announced == false) {
				...
				if(`${eventinfo[0].category}` === "Official") {
					...
					const shrugUsers = main.client.guilds.cache.get(`700208007530676314`).channels.cache.get(`700209759080546345`).messages.cache.get(`${eventinfo[0].embedid}`)//.reactions
					console.log(`------------------------`)
