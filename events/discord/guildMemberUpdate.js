...
module.exports = async (client, oldMember, newMember) => {
	...
	if (!oldRoles.includes(config.roles.bouncer) && newRoles.includes(config.roles.bouncer)) {
		...
		bouncerEmbed.setDescription(`Hey ${newMember}!\n\nYou have been added to the \`🧍🏿‍♂️  Bouncer\` role in the Karaoke Heaven server! We can't wait to get to know you and welcome you to our team. In order to get you fully setup, we'll have to get you into our slack!\n\n:speech_balloon: **Joining Slack:**\nIn order to download slack, [click here](https://slack.com/intl/en-gb/downloads/windows). Once you have downloaded slack, check your email account: you will have an invite to our slack workspace, please do not share any information about this.\n\n**:confused: Need help?**\nFeel free to private message a Manager with any questions you have about joining our slack workspacce or any other questions you have. We'll be happy to help you.`)		bouncerEmbed.setColor('#00FF00')
